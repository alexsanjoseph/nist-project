...
- Find out the times when the execution status was not active
- Find out the times when the machine was not feeding (PFR~0)
- Find the periods when the feed override was zero

We will be trying out all the approaches and choosing the one that is best for us.

```{r}
mtc_device@data_item_list[[2]]


```

##
and 2) when the machine was not wasting time travelling to origin. For this we have to 
